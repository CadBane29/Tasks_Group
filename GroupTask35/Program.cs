...
int[] array = CreateArrayInt(123, 1, 999);
PrintArray(array);
...
int elementArray = FindElementArray(array);
Console.WriteLine($"В данном массиве в отрезке от 10 до 99 --> {elementArray} значений.");